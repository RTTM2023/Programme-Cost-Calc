  ...
  <script>
    ...
    function toggleEngagementOptions() {
      ...
      if (engagement.startsWith("external") && learners > 0) {
        ...
        sessionDetails.innerHTML = `<p class="calculation-line"><strong>Calculation:</strong> ${learners} learners ÷ 25 pax = ${groups} group(s) × 5 sessions<br><strong>= ${sessions} sessions</strong></p>`;
      } else {
